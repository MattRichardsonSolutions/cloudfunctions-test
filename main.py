...
def create_agg():
    ...
    query = """
CREATE OR REPLACE TABLE `matthewr-playground.cloud_run_tmp.created_by_trigger` AS
SELECT 
  *
FROM `matthewr-playground.function_test.table_a`
where field_a > 10 and field_b > 10 and field_c >10
    """
    client.query(query)
    return query
